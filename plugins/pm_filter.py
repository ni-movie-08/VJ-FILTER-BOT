...
async def pm_text(bot, message):
    ...
    if PM_SEARCH == True:
        ...
        await message.reply_text(text=f"<b>ʜᴇʏ {user} 🦋 ,\n\nʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ᴍᴏᴠɪᴇs ꜰʀᴏᴍ ʜᴇʀᴇ. ʀᴇǫᴜᴇsᴛ ɪᴛ ɪɴ ᴏᴜʀ <a href=https://t.me/Ni_Movie_Request_Page>ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ</a> ᴏʀ ᴄʟɪᴄᴋ ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ 👇</b>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ", url=f"https://t.me/vj_bots")]]))
...
async def cb_handler(client: Client, query: CallbackQuery):
     ...
     #   if not search:
      ...
      #      return
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("Rᴇᴏ̨ᴜᴇsᴛ Gʀᴏᴜᴘ Lɪɴᴋ",url="https://t.me/Ni_Movie_Request_Group")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
    ...
    # don't change anything without contacting me @kingvj01
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Uᴘᴅᴀᴛᴇs', url="https://t.me/Ni_daily_updates")
        ],[
            InlineKeyboardButton('BᴀᴄᴋUᴘ', url="https://t.me/Ni_Movies"),
            InlineKeyboardButton('Bᴏᴛ ᴏᴡɴᴇʀ', url="https://t.me/Nishant_0786")
        ],[
            InlineKeyboardButton('Hᴏᴍᴇ', callback_data='start'),
            InlineKeyboardButton('Cʟᴏsᴇ', callback_data='close_data')
        ]]
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="help"),
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="telegram.me/Nishant_0786")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
...
async def auto_filter(client, name, msg, reply_msg, ai_search, spoll=False):
    ...
    if imdb:
        ...
        if settings["button"]:
            cap = f"<b><blockquote>📢Tʜᴇ Rᴇꜱᴜʟᴛꜱ Fᴏʀ ☞ {search}</blockquote>\n\n<b>🧑‍💻Rᴇǫᴜᴇsᴛᴇᴅ Bʏ : {message.from_user.mention}</blockquote>\n<b>⏳ 𝗥ᴇ𝘀ᴜʟᴛ 𝘀ʜᴏᴡɴ ɪɴ : {remaining_seconds} sᴇᴄᴏɴᴅs</>\n<b>✨ 𝗣ᴏᴡᴇʀᴇᴅ ʙʏ : {message.chat.title}</blockquote>\n\n<b><blockquote>⚠️ ᴀꜰᴛᴇʀ 5 ᴍɪɴᴜᴛᴇꜱ ᴛʜɪꜱ ᴍᴇꜱꜱᴀɢᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ 🗑️</blockquote>\n\n</b>"
        else:
            cap = f"<b><blockquote>📢Tʜᴇ Rᴇꜱᴜʟᴛꜱ Fᴏʀ ☞ {search}</blockquote>\n\n<b>🧑‍💻Rᴇǫᴜᴇsᴛᴇᴅ Bʏ : {message.from_user.mention}</b>\n<b>⏳ 𝗥ᴇ𝘀ᴜʟᴛ 𝘀ʜᴏᴡɴ ɪɴ : : {remaining_seconds} sᴇᴄᴏɴᴅs</>\n<b>✨ 𝗣ᴏᴡᴇʀᴇᴅ ʙʏ : {message.chat.title}</>\n\n<b><blockquote>⚠️ ᴀꜰᴛᴇʀ 5 ᴍɪɴᴜᴛᴇꜱ ᴛʜɪꜱ ᴍᴇꜱꜱᴀɢᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ 🗑️</blockquote>\n\n</b>"
...
async def advantage_spell_chok(client, name, msg, reply_msg, vj_search):
    ...
    if AI_SPELL_CHECK == True and vj_search == True:
        vj_search_new = False
        vj_ai_msg = await reply_msg.edit_text("<b><i>Advance Ai Try To Find Your Requested Movie With Your Wrong Spelling.</i></b>")
        movienamelist = []
